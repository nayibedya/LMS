...
<html>
	...
	<body>
		...
		<div class="w3-container w3-center w3-padding-64 w3-section">
			<h1 class="w3-wide w3-center">Faculty</h1>
			<div class="w3-container w3-padding w3-responsive">
				...
				<table class="w3-table-all w3-card">
					...
					<%
						ArrayList<LMSBean> al = (ArrayList<LMSBean>)session.getAttribute("facultyList"); 
						for(LMSBean b : al)
						{
					%>
							<tr>
								<td><%= b.getFacultyname() %></td>
